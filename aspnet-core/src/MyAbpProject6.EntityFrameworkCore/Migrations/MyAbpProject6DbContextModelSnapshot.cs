...
namespace MyAbpProject6.Migrations
{
    ...
    partial class MyAbpProject6DbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyAbpProject6.PhoneBooks.Persons.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyAbpProject6.PhoneBooks.PhoneNumbers.PhoneNumber", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("MyAbpProject6.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("MyAbpProject6.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("MyAbpProject6.PhoneBooks.PhoneNumbers.PhoneNumber", b =>
                {
                    b.HasOne("MyAbpProject6.PhoneBooks.Persons.Person", "Person")
                        .WithMany()
