...
{
    public abstract class MyAbpProject6WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MyAbpProject6WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MyAbpProject6WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MyAbpProject6DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MyAbpProject6DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MyAbpProject6DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MyAbpProject6DbContext, Task<T>> func)
        {
            T result;
